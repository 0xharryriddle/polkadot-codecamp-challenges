...
export default function SigpassKit() {
    ...
    return (
      <div className="flex flex-row gap-2 items-center">
        {!wallet && !account.isConnected && !address ? (
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" className="rounded-xl font-bold text-md hover:scale-105 transition-transform">
                {balance ? (
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>Your Sigpass wallet details</DialogDescription>
              </DialogHeader>
              <div className="flex flex-col gap-4">
  ...
  return (
    <div className="flex flex-row gap-2 items-center">
      {!wallet && !account.isConnected && !address ? (
        <Button className="rounded-xl font-bold text-sm" onClick={() => setOpen(true)}>
          Connect
        </Button>
      ) : wallet && !account.isConnected && address === undefined ? (
        ...
        <Button variant="outline" className="rounded-xl font-bold text-sm" onClick={() => setOpen(true)}>
